...
public final class SimpleComputationIT extends AbstractTestNGSpringContextTests {
	...
	@Test(groups = "integration", priority = Integer.MIN_VALUE) public void testIfIsRunning() {
		assertThat(workerService.isRunning()).isTrue();
	}

	@Test(groups = "integration") public void testIfLoadsConfig() throws FileNotFoundException, InterruptedException {
	...
	@Test(groups = "integration", dependsOnMethods = "testIfLoadsConfig") public void testIfRunsComputation()
