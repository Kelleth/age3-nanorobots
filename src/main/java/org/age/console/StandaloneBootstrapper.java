...
/**
 * Bootstraper for the standalone node.
 */
public final class StandaloneBootstrapper {

	private static final Logger log = LoggerFactory.getLogger(StandaloneBootstrapper.class);

	private StandaloneBootstrapper() {}

	public static void main(final String... args) throws InterruptedException {
		NodeLifecycleService lifecycleService = null;

		try (final ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("spring-standalone.xml")) {
