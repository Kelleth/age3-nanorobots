...
package org.age.compute.agent.agent.internal;
 ...
 * with Agent class in {@link org.age.compute.agent.agent.AgentBuilder} using proxy. This class shouldn't be used
